...
CREATE TABLE `countries` (
  `pk_country` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `code` int(3) NOT NULL,
...
CREATE TABLE `origins` (
  `pk_origin` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `rhums`
--

DROP TABLE IF EXISTS `rhums`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rhums` (
  `pk_rhum` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `trademarks` (
  `pk_trademark` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  `fk_origin` int(11) NOT NULL,
